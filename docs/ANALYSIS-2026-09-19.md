...
| Area | Files | Depth |
|------|-------|-------|
| Docs | README, SCOPE, REQUIREMENTS, SPECS, DECISIONS, OPEN-QUESTIONS, WORKSHOPS, GLOSSARY, REQUISITOS-REFACTOR-PYTHON (incl. §14 source index), examples JSON README + polar-0002/0003 | Full |
...
- [ ] Owner review of this file; corrections folded in.
- [ ] D01/D02 decision workshops scheduled.
- [ ] W1 case-file schema workshop.
