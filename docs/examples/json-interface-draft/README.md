...
Estes arquivos acompanham [os requisitos do refactor](<../../workshops/20260918-requisitos-legacy-analysis.md>). São exemplos de estrutura para revisão, não inputs homologados nem uma implementação do schema.
